...
<div class="sidebar">
    ...
    <div class="sidebar-brand">
        ...
        <span class="sidebar-brand-label">UMKM</span>
    </div>
    ...
    <ul class="sidebar-nav">
        <li>
            <a href="{{ route('dashboard.umkm') }}" @class(['active' => request()->routeIs('dashboard.umkm')])>
        ...
        <li>
            <a href="{{ route('umkm.assessment') }}" @class(['active' => request()->routeIs('umkm.assessment*')])>
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <li>
            <a href="{{ route('umkm.catalog') }}" @class(['active' => request()->routeIs('umkm.catalog*')])>
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <li>
            <a href="{{ route('umkm.produk_saya') }}" @class(['active' => request()->routeIs('umkm.produk_saya*')])>
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <ul class="sidebar-nav">
        <li>
            <a href="#" @class(['active' => request()->routeIs('umkm.profile*')])>
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <li>
            <a href="route('umkm.profile')" @class(['active' => request()->routeIs('umkm.pengaturan*')])>
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            ...
            <div>
                ...
                <div class="sidebar-user-sub">UMKM · {{ Auth::user()->phone ?? 'Aceh' }}</div>
            </div>
        </div>
