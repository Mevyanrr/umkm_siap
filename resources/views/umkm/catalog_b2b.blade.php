...
<div class="sidebar">
    ...
    <ul class="sidebar-nav">
        <li>
            <a href="{{ route('umkm.dashboard') }}" @class(['active' => request()->routeIs('umkm.dashboard')])>
    ...
    <ul class="sidebar-nav">
        <li>
            <a href="#" @class(['active' => request()->routeIs('umkm.profil*')])>
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <li>
            <a href="#" @class(['active' => request()->routeIs('umkm.pengaturan*')])>
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
