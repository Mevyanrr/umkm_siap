...
<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        <a href="{{ route('umkm.profile') }}" class="nav-item active">
...
<div class="main-content">
    ...
    <div class="page-title">Profil UMKM</div>
    <div class="page-sub">Kelola informasi akun dan bisnis Anda.</div>
    ...
    <div class="avatar-card">
        ...
        <div class="avatar-info">
            <h2>{{ $user->name }}</h2>
            <p>{{ $user->email }} · UMKM{{ $user->provinsi ? ' · ' . $user->provinsi : '' }}</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('umkm.profile.update') }}">
        ...
        <div class="form-card">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label class="form-label">Nama Usaha / Nama Lengkap <span style="color:#e54b4b">*</span></label>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select name="provinsi" class="form-input">
                        ...
                        @foreach($provinsiList as $prov)
                            <option value="{{ $prov }}"
                                {{ old('provinsi', $user->provinsi) === $prov ? 'selected' : '' }}>
                                {{ $prov }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" value="UMKM" disabled>
        ...
        <div class="form-actions">
            <a href="{{ route('dashboard.umkm') }}" class="btn-cancel">Batal</a>
